                            ...
                            args = {
                                ...
                                DebuffFramesDisplay = {
                                    ...
                                    args = {
                                        ...
                                        dispelPoint = {
                                            hidden = function() return not RaidFrameSettings.db.profile.Debuffs.DebuffFramesDisplay.showDispel end,
                                            order = 52,
                                            name = L["Debuffframe anchor"],
                                            type = "select",
                                            values = { L["Top Left"], L["Top"], L["Top Right"], L["Left"], L["Center"], L["Right"], L["Bottom Left"], L["Bottom"], L["Bottom Right"] },
                ...
                Config = {
                    ...
                    args = {
                        Curse = {
                            ...
                            name = L["Curse"],
                            type = "select",
                            values = { L["Always"], L["Has Dispel"], L["Can Dispel"], L["Not Use"] },
                            sorting = { 1, 2, 3, 4 },
                            get = "GetStatus",
                            set = "SetStatus",
                        },
                ...
                Etc = {
                    ...
                    args = {
                        playSound = {
                            ...
                            type = "select",
                            values = { L["Not Use"], L["Play sound when glowing"], L["Play sound only if dispelable"] },
                            sorting = { 1, 2, 3 },
                            get = "GetStatus2",
                            set = "SetStatus2",
                            width = 1.5,
